...
import type { RecipeItem, ShakeFlavor, StockItem } from "@/lib/types";
import { formatQty } from "@/lib/format";
import { createShakeFlavorAction, updateShakeFlavorAction } from "@/actions/shakes";
...
function FlavorForm({
  ...
  function submit() {
    ...
    startTransition(async () => {
      const result = flavor
        ? await updateShakeFlavorAction(flavor.id, { ...data, archived: flavor.archived })
        : await createShakeFlavorAction(data);
      if (result.ok) {
